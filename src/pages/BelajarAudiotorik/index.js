...
export default function GayaBelajarAudio({navigation}) {
  ...
  return (
    <View style={{flex:1, backgroundColor:'white'}}>
        ...
        {/* MAIN CONTENT SEPERTI SOAL UNTUK GAYA BELAJAR AUDIOTORIK */}
        <ScrollView>
{/* NANTI DISINI SOAL SOALNYA MASUKAN */}
        </ScrollView>

        {/* BOTTOM TAB SELESAI */}
        {/* AKAN NAVIGATE KE HALAMAN HASIL AUDIO */}
        <View style={{flexDirection:'row',padding:10}}>
        <View style={{
            flex:1,
            alignItems:"flex-end"
        }}>
            <TouchableNativeFeedback onPress={() => navigation.navigate('HasilBelajarAudio')}>
