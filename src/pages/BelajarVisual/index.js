...
export default function GayaBelajarVisual({navigation}) {
  ...
  return (
    <View style={{flex:1, backgroundColor:'white'}}>
        ...
        {/* MAIN CONTENT SEPERTI SOAL UNTUK GAYA BELAJAR VISUAL */}
        <ScrollView>
{/* NANTI DISINI SOAL SOALNYA MASUKAN */}
        ...
        <View style={{
            ...
            <TouchableNativeFeedback onPress={() => navigation.navigate('HasilBelajarVisual')}>
