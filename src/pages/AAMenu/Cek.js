        ...
        return (
            ...
            <View style={{
                ...
                <View style={{
                    ...
                    <TouchableOpacity onPress={() => navigation.navigate('CekEdit', item)} style={{
                        width: 30,
                        height: 30,
    ...
    return (
        <SafeAreaView style={{
            ...
            <View style={{
                ...
                <MyButton onPress={() => navigation.navigate('CekAdd', item)} title="Tambah" Icons="add" />
            </View>
        </SafeAreaView>
    )
}
