...
export default function ({ navigation, route }) {
    ...
    const __renderItem = ({ item }) => {
        return (
            ...
            <View style={{
                ...
                <TouchableOpacity onPress={() => navigation.navigate('StokDetail', item)} style={{
                    width: 100,
                    height: 30,
    ...
    return (
        <SafeAreaView style={{
            ...
            <MyHeader judul="Stock Opname Barang" onPress={() => navigation.goBack()} />
                ...
                <View style={{
                    ...
                    <View style={{
                        ...
                        <View style={{
                            ...
                            <MyButton onPress={() => navigation.navigate('StokAdd')} title="Tambah" Icons="duplicate" />
                        </View>
                        <View style={{
                            flex: 1,
                            paddingTop: 10,
